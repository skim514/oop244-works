...
namespace sdds{
    ...
    Item& Item::operator=(const Item& right)
    {
        if (this != &right){ //prevents self copying 
            setEmpty();
            if (right){ // the same as bool operator and !isEmpty
    ...
    ostream& Item::write(ostream& os) const
    {
        ...
        if (*this)
        {
            ...
            {
                os.width(7); os.fill(' ');
                os.setf(ios::left); os << m_SKU; os.unsetf(ios::left);
                os << "|";
                ...
                if (strlen(m_name) > 20)
                {
                    ...
                    os.width(20); os.fill(' ');
                    os.setf(ios::left); os << tempName; os.unsetf(ios::left);
                    os << "|";
                }
                else{
                    os.width(20); os.fill(' ');
                    os.setf(ios::left); os << m_name; os.unsetf(ios::left);
                    os << "|";
                }
                os.width(7); os.fill(' ');
                os.setf(ios::right); os.setf(ios::fixed); os.precision(2); os << m_price; os.unsetf(ios::right);
                if(m_isTaxed)
                {
                    os << "| X |";
                }
                ...
                os.width(4); os.fill(' ');
                os.setf(ios::right); os << quantity(); os.unsetf(ios::right);
                os << "|";
                os.width(9); os.fill(' ');
                os.setf(ios::right); os << cost() * quantity(); os.unsetf(ios::right);
                os << "|";
            }
